...
public class CruiseShipResource {
    ...
    public @ResponseBody List<CruiseShip> getCrusieShips(@PathVariable(value="cruiseshipid")int cruiseLineId){
        return cruiseShipController.getCruiseShips(cruiseLineId);
    }
